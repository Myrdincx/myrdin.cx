(async () => {
    try {
        ...
        const res = await fetch("https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=Myrdincx&api_key=5c1943b7296a4ae90c446fc14012a39f&format=json&limit=1");
